        ...
        <div className='bg-white md:pt-10'>
            <div className='mx-20 xl:mx-28 pt-10'>
                ...
                <div className='text-center mb-5 xl:mb-10'>
                    <div className='text-4xl font-bold text-[#211F32] mb-5'>{t('Popular Shop')}</div>
                    <div className='max-w-lg mx-auto'>{t('Visit our popular shops')}</div>
                </div>
                ...
                <div className='relative pb-10 scroll-smooth'>
                    ...
                    <SwiperPopular shop_tabs={shop_tabs} />
