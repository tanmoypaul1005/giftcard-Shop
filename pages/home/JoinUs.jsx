        ...
        <div className='relative bg-[#00949D] py-5 overflow-hidden'>
            <div className='custom-container py-5'>
                ...
                <div className='text-center mb-10'>
                    <div className='text-2xl md:text-4xl font-bold text-white mb-5'>Are You A Shop Owner?</div>
                </div>
            ...
            <img className='absolute top-[14px] left-[-74px] transform -translate-y-1/2 -rotate-[17deg] w-28 md:w-56 opacity-30' src="/Images/Ornaments/Ornament 74.png" alt="" />
