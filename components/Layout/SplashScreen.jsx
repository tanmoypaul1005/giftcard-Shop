            ...
            <div className="flex-col w-96">
                <div className='mx-16 mb-8'>
                    <div className='flex items-center justify-center'>
                        <img className={`transition-all ease-out duration-[1200ms] my-5 z-50 relative ${logoW}`} src={'/Images/svg/app_logo.svg'} alt="gifty" />
                ...
                <div className={`pt-10 text-5xl text-center w-full text-cBrand font-bold `}>
                    Gifty - ノンギフ
                </div>
            </div>
        </div>
